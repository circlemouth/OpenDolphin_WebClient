# 証跡ログ: 37 ユーティリティ導線統合確認（RUN_ID=20260112T061215Z）
...
- **Alt+P はフォーカス移動に失敗**（`#charts-patient-search` が DOM に存在せず、ショートカットが実行されない）。
  - 参考: `document.getElementById('charts-patient-search') === false` を確認。

## 証跡
- `artifacts/utility-panel-integration/20260112T061215Z-02/result.json`
- `artifacts/utility-panel-integration/20260112T061215Z-02/compact.png`
- `artifacts/utility-panel-integration/20260112T061215Z-02/expanded.png`
