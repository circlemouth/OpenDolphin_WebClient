...
| BKL-006/010/011/013 | Reception | `web-client/src/features/reception/pages/ReceptionPage.tsx` / `web-client/src/features/reception/api.ts` / `web-client/src/features/reception/components/*` | `/orca/appointments/list/*` `/orca/claim/outpatient` / 監査 API |
...
| BKL-005/008/017/018 | Charts（非カルテ領域） | `web-client/src/features/charts/*`（`print/` `DocumentTimeline.tsx` ほか） | `/orca21/medicalmodv2/outpatient` `/orca/claim/outpatient` / 監査 API |
...
| BKL-005 | `/orca/claim/outpatient` | 診療送信/結果反映（受付・会計連携）。 |
| BKL-006/010/011/013 | `/orca/appointments/list/*` | 受付一覧/例外一覧/監査検索の前提。 |
