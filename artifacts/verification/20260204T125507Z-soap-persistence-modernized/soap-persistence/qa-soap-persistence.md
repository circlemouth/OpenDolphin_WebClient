...
- 実施日時: 2026-02-04T12:56:16.509Z
- Base URL: http://localhost:5174
- Facility ID: 1.3.6.1.4.1.9414.72.103
- Patient ID: 01415
- SOAP テキスト: SOAPテスト 20260204T125507Z-soap-persistence-modernized
- 再表示結果: OK
...
- 入力後Subjective値: SOAPテスト 20260204T125507Z-soap-persistence-modernized
- SOAP guard: none
- SOAP feedback: none
- sessionStorage key: opendolphin:web-client:soap-history:v2:1.3.6.1.4.1.9414.72.103:doctor1
- sessionStorage length: 404
...
- console error count: 78
- console warning count: 22
- page error count: 0
...
- POST http://localhost:5174/orca/chart/subjectives

## SOAP Endpoint Responses

- 500 http://localhost:5174/orca/chart/subjectives
