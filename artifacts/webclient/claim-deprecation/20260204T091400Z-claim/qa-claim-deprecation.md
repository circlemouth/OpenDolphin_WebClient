...
- RUN_ID: 20260204T091400Z-claim
- 実施日時: 2026-02-04T00:18:37.948Z
...
| 項目 | URL | 期待 | 結果 | 証跡/備考 |
| --- | --- | --- | --- | --- |
| Reception: 外来リスト表示 | http://localhost:5173/f/1.3.6.1.4.1.9414.72.103/reception | reception-page が表示され、CLAIM 呼び出しが存在しない | OK | url=http://localhost:5173/f/1.3.6.1.4.1.9414.72.103/reception?sort=time&date=2026-02-04 / screenshots-claim-deprecation/01-reception-claim-deprecation.png |
