...
- RUN_ID: 20260106T212951Z
- 実施日時: 2026-01-06T21:31:16.192Z
...
| Administration: 管理画面表示 | https://localhost:4173/f/1.3.6.1.4.1.9414.72.103/administration | 管理画面が表示され、権限ガード（閲覧のみ）が出る | OK | url=https://localhost:4173/f/1.3.6.1.4.1.9414.72.103/administration / screenshots/05-administration.png / admin-guard=visible |
