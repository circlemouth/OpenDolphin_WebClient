...
- 実施日時: 2026-02-03T21:37:55.786Z
- Base URL: http://localhost:5173
- Facility ID: 1.3.6.1.4.1.9414.72.103
- セッションロール: admin
- シナリオ: msw-on
- console error count: 0
- console warning count: 3
...
- warning [audit] UI state schema warning {missing: Array(1), record: Object}
- warning [audit] UI state schema warning {missing: Array(1), record: Object}
- warning [chart-events] stream error TypeError: network error
