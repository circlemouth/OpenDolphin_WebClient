...
- RUN_ID: 20260203T111200Z
- 実施日時: 2026-02-03T10:58:20.661Z
- Base URL: http://localhost:5173
- Facility ID: 1.3.6.1.4.1.9414.72.103
- セッションロール: admin
- シナリオ: admin
- console error count: 15
- console warning count: 0
- console 404-ish count: 13
- network response count: 15
...
| Patients: サムネイル 404 抑止確認 | http://localhost:5173/f/1.3.6.1.4.1.9414.72.103/patients | patients-page が表示され、console error が抑止される | NG | TimeoutError: page.waitForURL: Timeout 30000ms exceeded.
=========================== logs ===========================
waiting for navigation to "**/patients" until "load"
============================================================ |
...
- error Failed to load resource: the server responded with a status of 404 (Not Found)
- error Failed to load resource: the server responded with a status of 404 (Not Found)
- error WebSocket connection to 'ws://localhost:5173/' failed: Error in connection establishment: net::ERR_CONNECTION_REFUSED
- error Failed to load resource: the server responded with a status of 404 (Not Found)
