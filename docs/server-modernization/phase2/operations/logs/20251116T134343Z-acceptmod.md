...
| 手順 | コマンド | 備考 |
| --- | --- | --- |
| 1 | `curl -vv -u <MASKED>:<MASKED> --data-binary @payloads/acceptmod_trial.xml https://weborca-trial.orca.med.or.jp/orca11/acceptmodv2?class=01` | HTTP 405 想定。`artifacts/orca-connectivity/20251116T134343Z/acceptmodv2/trial/` にログを保存。 |
