...
- コマンド: `curl -D headers_... -o response_... -u ormaster:******** -H 'Accept: application/xml' -H 'Content-Type: application/xml' --data-binary @request_2025-11-21T11-25-28Z.xml http://100.102.17.40:8000/orca11/acceptmodv2?class=01`
...
- コマンド: `curl -D headers_... -o response_... -u ormaster:******** -H 'Accept: application/xml' -H 'Content-Type: application/xml' --data-binary @request_2025-11-21T11-25-40Z.xml http://100.102.17.40:8000/orca14/appointmodv2?class=01`
...
- コマンド: `curl -D headers_... -o response_... -u ormaster:******** -H 'Accept: application/xml' -H 'Content-Type: application/xml' --data-binary @request_2025-11-21T11-25-53Z.xml http://100.102.17.40:8000/orca06/patientmemomodv2`
...
- コマンド: `curl -D headers_... -o response_... -u ormaster:******** -H 'Accept: application/json' -H 'Content-Type: application/json' --data-binary @request_2025-11-21T11-26-07Z.json http://100.102.17.40:8000/orca42/receiptprintv3`
...
## 3. 所見 / 次アクション
- POST 未開放が継続しているため、100.102.17.40 側の route/API_ENABLE 設定を開放するか、開放不可の場合は Blocker（HTTP405(Local)）としてステータス維持。
