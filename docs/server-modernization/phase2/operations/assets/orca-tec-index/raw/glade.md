...
[本文へジャンプ](https://www.orca.med.or.jp/receipt/tec/glade.html#content)
...
日医標準レセプトソフトはMONTSUQI を利用しています。MONTSUQIはLibgladeの機能を使い画面の表示制御をおこなっています。このため画面作成は [Glade](http://glade.gnome.org/)
での作成を前提としています。
...
[![このページのトップへ](https://www.orca.med.or.jp/images/common/to_page_top.gif)](https://www.orca.med.or.jp/receipt/tec/glade.html#wrapper)
