...
[本文へジャンプ](https://www.orca.med.or.jp/receipt/tec/montsuqi/overview.html#content)
...
ＤＢアクセスは、データベースに依存する可能性のあるSQLを使わず、CALL文を使用することによって、業務アプリケーションからは隠蔽され、データベースシステムに依存しない形になっています。
...
[![このページのトップへ](https://www.orca.med.or.jp/images/common/to_page_top.gif)](https://www.orca.med.or.jp/receipt/tec/montsuqi/overview.html#wrapper)
