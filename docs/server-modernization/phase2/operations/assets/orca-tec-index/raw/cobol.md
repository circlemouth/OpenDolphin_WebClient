...
[本文へジャンプ](https://www.orca.med.or.jp/receipt/tec/cobol.html#content)
...
日医標準レセプトソフト ではオープンソースな COBOL コンパイラである [OpenCOBOL](http://open-cobol.sourceforge.net/)
 を利用します。
...
COBOL コンパイラの使い方について詳しくは、OpenCOBOL の [マニュアル](http://open-cobol.sourceforge.net/open-cobol/)
 を参照して下さい。
...
[![このページのトップへ](https://www.orca.med.or.jp/images/common/to_page_top.gif)](https://www.orca.med.or.jp/receipt/tec/cobol.html#wrapper)
