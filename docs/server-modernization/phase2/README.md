...
- `operations/` 配下  
  Micrometer 移行・WildFly 設定 (`WILDFLY33_MICROMETER_OPERATIONS_GAP.md`) や JMS 再導入メモ (`WORKER0_MESSAGING_BACKLOG.md` / Archive: `../archive/2025Q4/server-modernization/phase2/operations/WORKER0_MESSAGING_BACKLOG.md`)。module_json JSON 化手順は `operations/MODULE_JSON_DEVELOPMENT.md`（RUN_ID=`20251214T082236Z`）を参照。
