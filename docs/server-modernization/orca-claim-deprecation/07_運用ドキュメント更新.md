...
- 将来の移管先（想定）: `docs/server-modernization/operations/ORCA_CERTIFICATION_ONLY.md`
- 移管手順（簡潔版）
  1. 上記パスに現行版を作成し、参照元を新パスへ更新する。
  2. 旧 `phase2/operations/ORCA_CERTIFICATION_ONLY.md` に Legacy 参照である旨を追記する。
  3. `docs/DEVELOPMENT_STATUS.md` に移管理由と RUN_ID を記録する。
