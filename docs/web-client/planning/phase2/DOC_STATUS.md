# DOC_STATUS（RUN_ID=`20251212T130647Z`）
...
| --- | --- | --- | --- | --- |
| `docs/web-client/README.md` | Web クライアントハブ | Active | 2025-12-12 | RUN_ID=`20251212T130647Z`。charts production outpatient plan のガント開始にあわせ RUN_ID/参照チェーンを同期。 |
...
| `docs/web-client/planning/phase2/DOC_STATUS.md` | 棚卸し台帳 | Active | 2025-12-12 | 本ファイル。RUN_ID=`20251212T130647Z`。 |
