...
| [`docs/server-modernization/phase2/operations/POSTGRES_BASELINE_RESTORE.md`](../../../server-modernization/phase2/operations/POSTGRES_BASELINE_RESTORE.md) | モダナイズ/DB | Active | 2025-11-08 | Secrets/VPN フローと `artifacts/parity-manual/db-restore/20251108T062436Z/` の実測ログに加え、2025-11-08T07:43Z 再試行ログを `20251108T074337Z/` へ保存・Ops 依頼テンプレを `baseline_search.log` へ追記済み。Secrets dump 受領後に成功ケースを追記するタスクが残る。 |
...
| [`docs/server-modernization/phase2/operations/EXTERNAL_INTERFACE_COMPATIBILITY_RUNBOOK.md`](../../../server-modernization/phase2/operations/EXTERNAL_INTERFACE_COMPATIBILITY_RUNBOOK.md) | モダナイズ/運用 | Active | 2025-11-08 | OBS-ACTUATOR-20251108-02 (legacy+modernized 成功ケース) を追記し、`artifacts/parity-manual/observability/20251108T074657Z-success/` と PagerDuty/Grafana 反映ログ `operations/logs/2025-11-08-pagerduty-observability.txt` をリンク。WebORCA 検証（`artifacts/orca-connectivity/20251108T075913Z/`）と external ネットワーク `orca-weborca` 自動接続手順を追記。 |
