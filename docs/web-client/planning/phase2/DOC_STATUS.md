...
| `src/charts_production_outpatient/quality/51_アクセシビリティ自動検査と手動監査.md` | Charts アクセシビリティ監査 | Active | 2025-12-17 | RUN_ID=`20251217T212939Z`。axe 重大違反 0、ActionBar フォーカス順と操作不能理由読み上げをテスト化。証跡: `docs/web-client/planning/phase2/logs/20251217T212939Z-charts-a11y.md`。 |
