# DOC_STATUS（RUN_ID=`20251212T140014Z`）
...
- 証跡ログ: `docs/web-client/planning/phase2/logs/20251212T140014Z-charts-page-gap.md`（ChartsPage 棚卸し）、`docs/web-client/planning/phase2/logs/20251212T131901Z-charts-outpatient-coverage.md`（カバレッジ定義）、`docs/web-client/planning/phase2/logs/20251212T130647Z-charts-production-outpatient-governance.md`（ガント起点）。

## Active ドキュメント（2025-12-12 現在）
| ドキュメント | スコープ | ステータス | 最終レビュー | 備考 / RUN_ID |
| --- | --- | --- | --- | --- |
| `docs/web-client/README.md` | Web クライアントハブ | Active | 2025-12-12 | RUN_ID=`20251212T140014Z`。ChartsPage 棚卸し（P0/P1/P2）を追加。 |
...
| `docs/web-client/planning/phase2/DOC_STATUS.md` | 棚卸し台帳 | Active | 2025-12-12 | 本ファイル。RUN_ID=`20251212T140014Z`。 |
