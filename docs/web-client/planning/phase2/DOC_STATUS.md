...
| [`docs/web-client/ux/ux-documentation-plan.md`](../../ux/ux-documentation-plan.md) | Web クライアント UX/Features | Active | 2025-12-03 | RUN_ID=`20251203T210000Z`（Charts カバレッジ：`docs/server-modernization/phase2/operations/logs/20251203T210000Z-charts-ux.md`、`artifacts/webclient/ux-notes/20251203T210000Z-charts-ux.md`）／RUN_ID=`20251204T160000Z`（Reception＋OrderConsole tone同期：`docs/server-modernization/phase2/operations/logs/20251204T160000Z-reception-design.md`、`artifacts/webclient/ux-notes/20251204T160000Z-reception-design.md`） |
