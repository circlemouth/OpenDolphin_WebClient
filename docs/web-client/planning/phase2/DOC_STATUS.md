# DOC_STATUS（RUN_ID=`20251212T143720Z`）
...
| `docs/web-client/planning/phase2/DOC_STATUS.md` | 棚卸し台帳 | Active | 2025-12-12 | 本ファイル。RUN_ID=`20251212T143720Z`。 |
...
| `docs/web-client/planning/phase2/logs/20251212T143720Z-charts-outpatient-api-contract.md` | Charts 外来 API 契約テーブル確定ログ | Active | 2025-12-12 | RUN_ID=`20251212T143720Z`。成果物 `src/charts_production_outpatient/03_モダナイズ外来API契約テーブル確定.md` を作成。 |
